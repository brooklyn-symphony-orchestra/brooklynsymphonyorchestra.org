...
$syncrun = new mailchimpSync('on', 1);
...
class mailchimpSync {
	...
	function __construct($debugging = 'off', $display_errors = 0) {
		...
		$this->config->base_url = 'http://brooklynsymphonyorchestra.org/wp-content/plugins/civicrm/civicrm/bin/mailchimp_sync.php';
		$this->apikey = "5523afd4ce0d94451fa65d8b0e1b3d00-us2";
		$this->list_id = "ae6f61dd50";
