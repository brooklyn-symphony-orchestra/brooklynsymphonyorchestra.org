...
<?php get_header(); ?>
        ...
        <div class="grid col-460">
			...
			// First let's check if headline was set
			    if (!empty($options['cta_url']) && $options['cta_text']) {
					echo '<a href="'.$options['cta_url'].'" target="_blank" class="blue button">'; 
        ...
        <div id="featured-image" class="grid col-460 fit"> 
		    ...
		    // If not display dummy image for preview purposes
                    ...
                    echo '<iframe width="460" height="345" src="http://www.youtube.com/embed/tw9ePJwDL8k?rel=0" frameborder="0" allowfullscreen></iframe>'; 
 				  }
			?> 
